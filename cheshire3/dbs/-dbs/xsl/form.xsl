...
<!-- SUBJECT -->
		<div id="subject" class="apcontainer">
			...
			<div id="subjecttable" class="tablecontainer">
				<table>
				<tbody>
			    	<tr><td class="label">Subject:</td><td><input type="text" onfocus="parent.setCurrent(this);" id="su_subject" size="40"></input></td></tr>
			    	<tr><td><select onfocus="parent.setCurrent(this);" id="subjectdropdown">
			    		<option value="su_dates">Dates</option>
			    		<option value="su_loc">Location</option>
			    		<option value="su_other">Other</option>
			    		<option value="su_source">Thesaurus</option>			    		
			    	</select></td><td><input class="apbutton" type="button" value="Add Field" onclick="addField('subject')"></input></td></tr>
			    </tbody>
			...
			<!--    <input class="apbutton" type="button" onclick="opensearch(0);" value="Search UNESCO" ></input><br/>-->
		  	<!--    <input class="apbutton" type="button" onclick="window.open('http://fantasia.cse.msstate.edu/lcshdb/index.cgi');" value="Search LCSH" ></input><br/>	-->			     
		  	    <input class="apbutton" type="button" onclick="addAccessPoint('subject');" value="Add Subject" ></input><br/>
		  	    <input class="apbutton" type="button" onclick="addAccessPoint('subject');" value="Reset" ></input>
			</div>
			<br/>
		</div>
		<br/>	
<!--PERSNAME -->
        <div id="persname" class="apcontainer">				
			...
			<div id="persnametable" class="tablecontainer">					
				<table>
					<tr><td class="label"><select><option>Surname</option><option>Forename</option><option>Dates</option><option>Title</option><option>Epithet</option><option>Other</option><option>Source</option></select></td><td> <input type="text" onfocus="parent.setCurrent(this);" id="pn_surname" size="40"></input></td></tr>
					<tr><td><input type="button" size="25" value="Add Field" onclick="addField(subject)"></input></td><td></td></tr>
			<!--  	<tr><td class="label"> Surname:</td><td> <input type="text" onfocus="parent.setCurrent(this);" id="pn_surname" size="40"></input></td></tr>
			...
			<!-- 	<input class="apbutton" type="button" onclick="window.open('http://www.hmc.gov.uk/nra/personal_simple.htm', 'new', 'width=800 height=600');" value="Search NRA" ></input><br/> -->
				<input class="apbutton" type="button" onclick="addAccessPoint('persname');" value="Add Persname" ></input>
			</div>
			<br/>
		</div>
		<br/>
<!--FAMNAME -->
		<div id="famname" class="apcontainer">
			...
			<div id="famnametable" class="tablecontainer">
			      <table>
					  <tr><td class="label">Surname:</td><td> <input type="text" onfocus="parent.setCurrent(this);" id="fn_surname" size="40"></input></td></tr>
			...
			<div id="famnamebuttons" class="buttoncontainer">
				...
				<input class="apbutton" type="button" onclick="addAccessPoint('famname');" value="Add Famname"></input>
			</div>
			<br/>
		</div>
		<br/>		
		<div id="corpname" class="apcontainer">
			...
			<div id="corpnametable" class="tablecontainer">
				<table>
			    	<tr><td class="label">Organisation:</td><td><input type="text" onfocus="parent.setCurrent(this);" id="cn_organisation" size="40"></input></td></tr>
			...
			<div id="corpnamebuttons" class="buttoncontainer">
				...
				<input class="apbutton" type="button" onclick="addAccessPoint('corpname');" value="Add Corpname"></input>
			</div>
			<br/>
		</div>
		<br/>	
		...
		<div id="geogname" class="apcontainer">
			...
			<xsl:choose>
				...
				<div id="geognametable" class="tablecontainer">
				    <table>
						<tr><td class="label">Location:</td><td> <input type="text" onfocus="parent.setCurrent(this);" id="gn_geogname" size="40"></input></td></tr>
				...
				<div id="geognamebuttons" class="buttoncontainer">
					...
					<input class="apbutton" type="button" onclick="addAccessPoint('geogname');" value="Add Geogname"></input>
				</div>
				<br/>
		</div>
		<br/>
		...
		<div id="title" class="apcontainer">
			...
			<xsl:choose>
				...
				<div id="titletable" class="tablecontainer">
					<table>
						<tr><td class="label">Title:</td><td> <input type="text" onfocus="parent.setCurrent(this);" id="bt_title" size="40"></input></td></tr>
				...
				<div id="titlebuttons" class="buttoncontainer">
					<p class="apbutton">Rules:
						...
						<input class="apbutton" type="button" onclick="addAccessPoint('title');" value="Add Title"></input>
				</div>
				<br/>
			</div>
			<br/>						
