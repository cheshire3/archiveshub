...
function addField(s){
	...
	cell3.innerHTML = '<img onmouseover="this.style.cursor=\'pointer\'" src="/images/delete.png" onclick="deleteRow(this.parentNode.parentNode);" />';
		  	...
		  	if (i == 0){
	  			...
	  			if (value[0].split('_', 2)[1] == 'rules'){
					...
					if (value[0].split('_', 2)[1] == 'source'){
						...
						var cell3 = document.createElement('td');
						cell3.innerHTML = '<img src="/images/delete.png" onclick="deleteRow(this.parentNode.parentNode);" />';
						newRow.appendChild(cell3);		
				  		table.insertBefore(newRow, dropdownRow);			  		
				  	}
			  	}		  	
...
function createIcons(s){
   ...
   var d = "'" + s + nameCount + "'";
   var s = "'" + s + "'";
   innerHTMLString = '<a onclick ="deleteAccessPoint(' + d + ');" title="delete entry"><img src = "/images/delete.png" id="delete' + nameCount + '"/></a>'; 
