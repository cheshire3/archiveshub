...
<xsl:stylesheet
        ...
        <table
            ...
            <xsl:if test="unitid[@type='previous'] or
                ...
                <tr>
                    ...
                    <td>
                        <xsl:apply-templates
                            select="unitid[@type='previous']" />
                        <xsl:apply-templates
                            select="unitid[@label='former']" />
                    </td>
                </tr>
            </xsl:if>
        ...
        <div id="utilitybar" class="bar utility">
            ...
            <ul class="detail">
                <li>
                    ...
                    <xsl:text>of this material </xsl:text>
            ...
            <!-- Information -->
            <p>
                <xsl:text>Archives described on the Archives Hub are held in repositories across the UK</xsl:text>
            </p>
            <ul class="info">
                <li>
                    <a class="bgimg contact">
                        <xsl:attribute name="href">
                            ...
                            <xsl:text>?subject=Query%20via%20the%20Archives%20Hub%20about%20RECID</xsl:text>
                        </xsl:attribute>
                        <xsl:attribute name="title">
                            <xsl:text>Send an Email to the repository for more information [opens new email window]</xsl:text>
                        </xsl:attribute>
                        <xsl:text>Email</xsl:text>
                    </a>
                    <xsl:text>the repository for more information</xsl:text>
                </li>
                <li>
                    ...
                    <xsl:text>of the repository</xsl:text>
                </li>
                <li>
                    More about&#160;
            ...
            <ul class="actions" id="addright">
                ...
                <li>
                    <a class="bgimg tip email disabled">
                        <xsl:attribute name="href">
                ...
                <li>
                    <a class="bgimg tip xml disabled">
                        <xsl:attribute name="href">
                    ...
                    <a class="bgimg tip text disabled">
                        <xsl:attribute name="href">
                            <xsl:value-of select="$data_uri_base" />
                ...
                <li>
                    <!-- AddThis Buttons Removed from preview BEGIN -->
                    <span>
                        <xsl:attribute name="title">
                            <xsl:text>Social media sharing links will be added here when viewed in the live service.</xsl:text>
                        </xsl:attribute>
                        <xsl:text>More share Links</xsl:text>
                    </span>
                </li>
            </ul>
    ...
    <xsl:template name="browselink">
        ...
        <a>
          ...
          <xsl:attribute name="class">
            <xsl:text>ajax browselink disabled</xsl:text>
          </xsl:attribute>
	      <xsl:apply-templates select="."/>
	    </a>
	</xsl:template>
