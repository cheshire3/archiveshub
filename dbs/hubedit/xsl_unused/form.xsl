...
<xsl:stylesheet
    ...
    <xsl:template name="addButton">
        <xsl:element name="img">
            ...
            <xsl:text>http://archiveshub.ac.uk/img/structure/form_add_row.png</xsl:text>
        </xsl:attribute>
                ...
                <div id="formDiv" name="form" class="formDiv">
                    <form id="eadForm" name="eadForm" action="#">
                        ...
                        <div class="pui">
                            ...
                            <a
                                href="http://www.archiveshub.ac.uk/help/glossary/#identifier"
                                title="PUI help - opens in new window" class="tip"
                                target="_new">
                                <img src="/img/structure/form_tip.png"
                                    alt="[?]" />
                            </a>
                            %PUI%
                        </div>
    ...
    <xsl:template
        ...
        <xsl:if test="not(name() = 'archdesc')">
            <p>
                <input type="hidden" name="ctype" id="ctype" maxlength="3"
                    size="4">
                    <xsl:attribute name="value">
        ...
        <div id="sec-3-1" class="section">
            ...
            <xsl:if test="$formtype = 'ead'">
                <p id="unitidparent">
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/refcode"
            ...
            <p>
                ...
                <a href="http://www.archiveshub.ac.uk/help/title" class="tip"
                ...
                <xsl:otherwise>
                    <div class="clear">
                        <div class="float">
                            ...
                            <a href="http://www.archiveshub.ac.uk/help/dates"
                                class="tip"
                            ...
                            <input class="menuField" type="text"
                                ...
                                onchange="validateField(this, 'true');"
                                onblur="validateField(this, 'true');" name="did/unitdate[1]"
                                id="did/unitdate[1]" size="39" />
                        </div>
                        <div class="float">
                            <strong>
                            ...
                            <input class="dateOK" type="text"
                                onfocus="setCurrent(this);" onkeypress="validateNormdateDelay(this, 'true');"
                                onchange="validateNormdate(this, 'true');"
                                onblur="validateNormdate(this, 'true');" name="did/unitdate[1]/@normal"
                                id="did/unitdate[1]/@normal" size="39"
                                maxlength="21" />
                        </div>
                    </div>
                </xsl:otherwise>
            ...
            <p>
                ...
                <a href="http://www.archiveshub.ac.uk/help/level" class="tip"
            ...
            <p>
                ...
                <a href="http://www.archiveshub.ac.uk/help/extent" class="tip"
                    title="Extent help - opens in new window" target="_new">
                    <img src="/img/structure/form_tip.png" alt="[?]" />
                </a>
                <br />
                <xsl:choose>
            ...
            <xsl:if test="$leveltype = 'collection' or $formtype = 'template'">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/repository"
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <input class="menuField" type="text"
                                onfocus="setCurrent(this);" onkeypress="validateFieldDelay(this, 'true');"
                                onchange="validateField(this, 'true');"
                                onblur="validateField(this, 'true');" name="did/repository"
                                id="did/repository" size="60"></input>
                        </xsl:otherwise>
                    </xsl:choose>
                </p>
                <p>
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            ...
                            <a href="http://www.archiveshub.ac.uk/help/sponsor"
        ...
        <div class="section">
            ...
            <p>
                ...
                <a href="http://www.archiveshub.ac.uk/help/name" class="tip"
                        ...
                        <xsl:for-each select="bioghist">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/bioghist'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="custodhist">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/custodhist'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="acqinfo">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/acqinfo'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="scopecontent">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/scope'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <xsl:for-each select="appraisal">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="title"
                                    select="'Appraisal'" />
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/appraisal'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <xsl:for-each select="accruals">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="title"
                                    select="'Accruals'" />
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/accruals'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="arrangement">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/arrangement'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
        ...
        <div class="section">
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="accessrestrict">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/restrict'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="userestrict">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/userestrict'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
            ...
            <p>
                ...
                <a href="http://www.archiveshub.ac.uk/help/lang" class="tip"
                ...
                <div id="language" class="langcontainer">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="lang_name"
                                            onfocus="setCurrent(this);" size="35"></input>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div id="languagebuttons" class="buttoncontainer">
                        <input class="apbutton" type="button" onclick="addLanguage();"
                            value="Add to Record"></input>
                        <br />
                        <input class="apbutton" type="button"
                            onclick="resetAccessPoint('language');" value="Reset"></input>
                    </div>
                </div>
                <br />
            </p>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="phystech">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/phystech'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <xsl:for-each select="otherfindaid">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="title"
                                    select="'Finding Aids'" />
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/other'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="originalsloc">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/originalsloc'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="altformavail">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/altformavail'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                    ...
                    <xsl:when test="$content = 'true'">
                        <xsl:for-each select="bibliography">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/bibliography'" />
                        ...
                        <xsl:for-each select="note">
                            <xsl:call-template name="textarea">
                                ...
                                <xsl:with-param name="title"
                                    select="'Note'" />
                                <xsl:with-param name="help"
                                    select="'http://www.archiveshub.ac.uk/help/note'" />
                            </xsl:call-template>
                        </xsl:for-each>
                    </xsl:when>
                    <xsl:otherwise>
                        ...
                        <xsl:when test="$content = 'true'">
                            <xsl:for-each select="processinfo">
                                <xsl:call-template name="textarea">
                                    ...
                                    <xsl:with-param name="help"
                                        select="'http://www.archiveshub.ac.uk/help/archnote'" />
                                </xsl:call-template>
                            </xsl:for-each>
                        </xsl:when>
                        <xsl:otherwise>
        ...
        <div id="digitalobjectssection" class="section">
            <h3>
                Digital Objects
                <a href="http://www.archiveshub.ac.uk/help/dao" class="tip"
            ...
            <div id="daocontainer">
                ...
                <div id="createnewdao">
                    ...
                    <select name="daoselect" id="daoselect">
                        ...
                        <option value="thumb">Display thumbnail link to file
                        </option>
        ...
        <div id="accesspointssection" class="section">
            <h3>
                Access Points
                <a href="http://www.archiveshub.ac.uk/help/access" class="tip"
            ...
            <div id="subject" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/subject"
                    ...
                    <!--
                        <a class="extSearch"
                        onclick="window.open('http://databases.unesco.org/thesaurus/',
                        'new');">[Search UNESCO]</a>
                    -->
                    ...
                    <!--
                        <a class="extSearch"
                        onclick="window.open('http://authorities.loc.gov/cgi-bin/Pwebrecon.cgi?DB=local&amp;PAGE=First',
                        'new');">[Search LCSH]</a>
                    -->
                    <a class="extSearch" target="_new"
                            ...
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    ...
                                    <!--
                                        <input type="text"
                                        onfocus="setCurrent(this);"
                                        id="subject_source" size="35"></input>
                                    -->
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <a class="addfield" onclick="addField('subject');">Add Selected
                                        Field</a>
                                    <!--
                                        <input type="text"
                                        onfocus="addField('subject')"
                                        size="35" value="Add Selected Field"
                                        style="background:#F2F2F2; color:
                                        grey;"></input>
                                    -->
                                </td>
                            </tr>
            ...
            <div id="persname" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/persname"
                    ...
                    <!--
                        <a class="extSearch"
                        onclick="window.open('http://www.nationalarchives.gov.uk/nra/searches/simpleSearch.asp?subjectType=P',
                        'new');">[Search NRA]</a>
                    -->
                    <a class="extSearch" target="_new"
                    ...
                    <table id="table_persname">
                        <tbody>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="persname_surname" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="persname_forename" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="persname_source" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td>
                                ...
                                <td>
                                    <a class="addfield" onclick="addField('persname');">Add Selected
                                        Field</a>
                                    <!--
                                        <input type="text"
                                        onfocus="addField('persname')"
                                        size="35" value="Click to Add Selected
            ...
            <div id="famname" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/famname"
                    ...
                    <!--
                        <a class="extSearch"
                        onclick="window.open('http://www.nationalarchives.gov.uk/nra/searches/simpleSearch.asp?subjectType=F',
                        'new');">[Search NRA]</a>
                    -->
                    <a class="extSearch" target="_new"
                    ...
                    <table id="table_famname">
                        <tbody>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="famname_surname" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td class="label">Source:</td>
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="famname_source" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td>
                                ...
                                <td>
                                    <a class="addfield" onclick="addField('famname');">Add Selected
                                        Field</a>
                                    <!--
                                        <input type="text"
                                        onfocus="addField('famname')"
                                        size="35" value="Click to Add Selected
                                        Field" style="background:#F2F2F2;
                                        color: grey;"></input>
                                    -->
            ...
            <div id="corpname" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/corpname"
                    ...
                    <!--
                        <a class="extSearch"
                        onclick="window.open('http://www.nationalarchives.gov.uk/nra/searches/simpleSearch.asp?subjectType=O',
                        'new');">[Search NRA]</a>
                    -->
                    <a class="extSearch" target="_new"
                    ...
                    <table id="table_corpname">
                        <tbody>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="corpname_organisation" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td class="label">Source:</td>
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="corpname_source" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td>
                                ...
                                <td>
                                    <a class="addfield" onclick="addField('corpname');">Add Selected
                                        Field</a>
                                    <!--
                                        <input type="text"
                                        onfocus="addField('corpname')"
                                        size="35" value="Click to Add Selected
                                        Field" style="background:#F2F2F2;
                                        color: grey;"></input>
                                    -->
            ...
            <div id="geogname" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/geogname"
                    ...
                    <!--
                        <a class="extSearch"
                        onclick="window.open('http://www.nationalarchives.gov.uk/nra/searches/simpleSearch.asp?subjectType=PL',
                        'new');">[Search NRA]</a>
                    -->
                    <a class="extSearch" target="_new"
                    ...
                    <table id="table_geogname">
                        <tbody>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="geogname_location" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td class="label">Source:</td>
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="geogname_source" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td>
                                ...
                                <td>
                                    <a class="addfield" onclick="addField('geogname');">Add Selected
                                        Field</a>
                                    <!--
                                        <input type="text"
                                        onfocus="addField('geogname')"
                                        size="35" value="Click to Add Selected
                                        Field" style="background:#F2F2F2;
                                        color: grey;"></input>
                                    -->
            ...
            <div id="title" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/booktitle"
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <div id="addedtitles" style="display:none" class="added">
                            <xsl:text> </xsl:text>
                        </div>
                    </xsl:otherwise>
                </xsl:choose>
                    ...
                    <table id="table_title">
                        <tbody>
                            ...
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <a class="addfield" onclick="addField('title');">Add Selected
                                        Field</a>
                                    <!--
                                        <input type="text"
                                        onfocus="addField('title')" size="35"
                                        value="Click to Add Selected Field"
                                        style="background:#F2F2F2; color:
                                        grey;"></input>
                                    -->
                                </td>
            ...
            <div id="genreform" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/genreform"
                    ...
                    <table id="table_genreform">
                        <tbody>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="genreform_genre" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td class="label">Source:</td>
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="genreform_source" size="35"></input>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div id="function" class="apcontainer">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/function"
                    ...
                    <table id="table_function">
                        <tbody>
                            <tr NoDrop="true" NoDrag="true">
                                ...
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="function_function" size="35"></input>
                                </td>
                            </tr>
                            <tr NoDrop="true" NoDrag="true">
                                <td class="label">Source:</td>
                                <td>
                                    <input type="text" onfocus="setCurrent(this);"
                                        id="function_source" size="35"></input>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div>
                    ...
                    <div class="icons">
                        <a>
                            ...
                            <img src="/img/delete.png" class="deletelogo"
                                alt="X">
                                <xsl:attribute name="onmouseover">
                                <xsl:text>this.src='/img/delete-hover.png';</xsl:text>
                            </xsl:attribute>
                                <xsl:attribute name="onmouseout">
                                <xsl:text>this.src='/img/delete.png';</xsl:text>
                            </xsl:attribute>
                                <xsl:attribute name="id">
        ...
        <div class="clear">
            <div class="float">
                <p>
                    ...
                    <a href="http://www.archiveshub.ac.uk/help/dates" class="tip"
                        title="Dates of Creation help - opens in new window"
                        target="_new">
                        <img src="/img/structure/form_tip.png" alt="[?]" />
                    </a>
    ...
    <xsl:template match="/ead/eadheader/filedesc/titlestmt/sponsor">
        <strong>Sponsor</strong>
        <a href="http://www.archiveshub.ac.uk/help/sponsor" class="tip"
        ...
        <div id="addedlanguages" style="display:block" class="added">
            <xsl:for-each select="language">
                <input type="hidden" name="did/langmaterial/language">
                    ...
                    <xsl:attribute name="value">
					<xsl:text>lang_code | </xsl:text><xsl:value-of select="@langcode" /><xsl:text> ||| lang_name | </xsl:text><xsl:value-of
  ...
  <xsl:template name="multiple">
  	...
  	<table class="daotable"><tbody>
  		<xsl:for-each select="daoloc">
  			...
  			<td>
	  			<input type="text" size="60" onfocus="setCurrent(this);">
	  				<xsl:attribute name="name">
