...
<xsl:stylesheet
    ...
    <!--
    import configuration from external file - over-rideable locally 
    (i.e. in this file)
    -->
    ...
    <xsl:template match="/ead">
        ...
        <xsl:if test="/ead/archdesc/admininfo">
            ...
            <xsl:apply-templates
                select="/ead/archdesc/admininfo/accessrestrict" />
        ...
        <xsl:if test="/ead/archdesc/descgrp">
            ...
            <xsl:apply-templates
                select="/ead/archdesc/descgrp/separatedmaterial" />
        </xsl:if>
