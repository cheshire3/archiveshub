...
# 0.03 - 26/09/2007 - JH - Mods to component search display to accommodate hierarchy of titles
#                        - Folder tags added
...
subject_resolve_no_hits = u'''
    <div id="single" class="subjectresults">
        <p><strong>No relevant terms were found.</strong></p>
...
<div id="notes">
  ...
  <em>
    <ul>
      <li>
          You should avoid using spaces, accented characters, or punctuation 
          in the filename. e.g. slashes, full-stops etc. Dashes are OK.
      </li>
      <li>
          As a file extension (e.g. \'sgml\', \'xml\') is essential, this 
          will be added automatically. You may choose which of these is 
